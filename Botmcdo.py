...
# ================= SAFE CONFIG =================
BOT_TOKEN = "8631179355:AAFdcqMSkeBtALMhpNWhlW8ocMn0OLv9-Ys"   # ← Nouveau token
...
async def set_ticket(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("✅ Ticket du jour mis à jour avec succès !")
...
async def add_vip(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text(f"✅ VIP ajouté pour l'ID {user_id}")
    except:
        await update.message.reply_text("❌ Erreur : ID invalide")
