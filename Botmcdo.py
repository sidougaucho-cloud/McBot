...
⭐ VIP = Accès exclusif au **Prono du jour** uniquement
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Ticket du jour → Accessible à tous
...
if __name__ == "__main__":
    ...
    print("🚀 Bot démarré - VIP uniquement pour Prono du jour")
    app.run_polling()
