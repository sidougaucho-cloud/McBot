...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ================= AUTRES MENUS (Correction principale) =================
    if data.startswith("menu_"):
        ...
        if cat in PRODUITS:
            ...
            await query.edit_message_text(f"📦 Produits {cat.upper()}", reply_markup=InlineKeyboardMarkup(kb))
            return
    ...
    if data.startswith("buy_"):
        ...
        await query.edit_message_text(
            ...
            f"💰 Prix : **{prix}€**\n\n"
            f"🔗 Paye ici :\n{paypal_link}\n\n"
            f"📸 Une fois payé, envoie une capture.",
            parse_mode="Markdown",
            reply_markup=InlineKeyboardMarkup([
...
if __name__ == "__main__":
    ...
    print("🚀 Bot démarré - Tous les menus corrigés")
    app.run_polling()
