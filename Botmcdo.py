...
⭐ VIP = Accès exclusif au Prono du jour
    ...
    if data == "menu_prono":
        if not is_vip(user_id):
            await query.edit_message_text(
                "❌ **Accès refusé**\n\n"
                "Cette section est réservée aux abonnés **VIP**.\n"
                "Souscris à l'abonnement VIP pour y accéder.",
...
if __name__ == "__main__":
    ...
    print("🚀 Bot démarré avec système VIP")
    app.run_polling()
